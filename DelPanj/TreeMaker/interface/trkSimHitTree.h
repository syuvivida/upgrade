...
class trkSimHitTree : public baseTree{
 ...
 public:
  ...
  std::vector<Float_t> hitEntryPointX_;
  std::vector<Float_t> hitEntryPointY_;
  std::vector<Float_t> hitEntryPointZ_;

  std::vector<Float_t> hitExitPointX_;
  std::vector<Float_t> hitExitPointY_;
  std::vector<Float_t> hitExitPointZ_;
